...
call dein#add('preservim/nerdcommenter', {'hook_source': ':call completer#Nerdcommenter()'})
...
call dein#add('wellle/context.vim') " Context: Show the function, for-loop and condition.
call dein#add('luochen1990/rainbow', {'hook_source': ':call view#Rainbow()'})
call dein#add('psliwka/vim-smoothie')
call dein#add('itchyny/lightline.vim') " lightline does not process buffer in tabline
